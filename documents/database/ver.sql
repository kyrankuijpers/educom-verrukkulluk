...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 10, 2025 at 10:02 AM
...
(15, 'Tuinerwten', 'Diepgevroren erwten', 320, 'kg', 1, 'fdsvdfhgafg'),
...
ALTER TABLE `ingredient`
  ...
  ADD CONSTRAINT `ingredient_recipe` FOREIGN KEY (`recipe_id`) REFERENCES `recipe` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
--
ALTER TABLE `recipe_info`
  ADD CONSTRAINT `recipe_info_recipe` FOREIGN KEY (`recipe_id`) REFERENCES `recipe` (`id`) ON DELETE SET NULL;
COMMIT;
